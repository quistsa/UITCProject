    ...
    async requestLogin(req, res, next) {
        ...
        if(!user || user == null){
            ...
            req.session.regenerate((err) => {
                ...
                if (user.userID == "UITCAdmin2023"){ //since only one admin login is used in this version, the username is hardcoded. If more admin users are required, follow comments in the user.js and facultyForm.ejs files.
